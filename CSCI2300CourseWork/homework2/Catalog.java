...
public class Catalog
{
   ...
   /**
    * Instantiate an empty list of catalog items
    */
   ...
   public Catalog(ArrayList<CatalogItem> items)
   {
	   catalogItems = new ArrayList<CatalogItem>();
	   
	   if (checkUniqueId(items)==false){
		   throw new IllegalArgumentException("IDs must be unique");
	   }
	   catalogItems.addAll(items);
   }
   
   public boolean checkUniqueId(ArrayList<CatalogItem> items){
		boolean unique = true;
